...
export default function SideNav() {
	...
	return (
		<div className="w-[50%] max-w-52 px-2 rounded-lg fixed bottom-5 left-1/2 -translate-x-1/2 bg-primary-gray-800 grid grid-cols-3 gap-2 grid-flow-col justify-items-center z-20">
